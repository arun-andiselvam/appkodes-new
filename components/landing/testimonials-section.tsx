...
export function TestimonialsSection() {
  ...
  return (
    <section
      id="testimonials"
      ref={sectionRef}
      className="relative py-20 lg:py-24 border-t border-foreground/10 overflow-hidden"
    >
      ...
      */}
      ...
      {/* Controls */}
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12 mt-8 flex items-center gap-3">
        <button
          type="button"
