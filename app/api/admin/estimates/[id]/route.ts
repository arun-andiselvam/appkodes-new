...
/**
 * Approving an estimate, and sending it.
 *
 ...
 *
 * Authentication is the basic auth gate in proxy.ts, which covers /api/admin
 * as well as /admin. Read the shouted note there before assuming this route
 * defends itself - it does not, deliberately, because one gate that runs first
 * beats a check on every route that somebody eventually forgets.
 */
